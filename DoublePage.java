...
public class DoublePage extends JFrame implements ActionListener{
	...
	private void mainLabels() {
		...
		JLabel title = new JLabel("Twin Bedwise Registration");
		...
		JLabel roomType = new JLabel("Twin Bedwise");
		roomType.setBounds(120,220,getWidth()-30, 40);
	...
	public void actionPerformed(ActionEvent e) {
	    ...
	    int roomnum = (lastAssignedRoom % Space.length) + 6;
	    ...
	    if(e.getSource()==backBtn) {
	        ...
	        if (e.getSource() == this.proceedBtn) {
	            ...
	            this.dispose();
	            new SecondPayment(userData, this.checkIn, this.checkOut, roomnum);
