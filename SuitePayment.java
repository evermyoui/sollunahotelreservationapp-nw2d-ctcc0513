...
public class SuitePayment extends JFrame implements ActionListener{
	...
	public SuitePayment(String [] userData, Date checkIn,Date checkOut,int roomnum) {
				...
				totalPay = (int) (convertedTime *5000); 
	...
	private void mainLabels() {
		...
		JLabel singleTxt = new JLabel("Super Suite");
	...
	private Icon singleIcon() {
		ImageIcon icon = new ImageIcon("C:\\Users\\User\\Downloads\\superSuite.jpg");
		return icon;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==confirmBtn) {
            ...
            adminPage.addBooking(firstName + " " + lastName, email, checkIn, checkOut, roomNumber,"Super Suite");
