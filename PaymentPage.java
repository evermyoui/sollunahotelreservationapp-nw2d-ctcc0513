...
public class PaymentPage extends JFrame implements ActionListener{
	...
	public PaymentPage(String [] userData, Date checkIn,Date checkOut,int roomnum) {
				...
				totalPay = (int) (convertedTime *1000); 
	...
	private void mainLabels() {
		...
		JLabel singleTxt = new JLabel("Sleeping One");
	...
	private Icon singleIcon() {
		ImageIcon icon = new ImageIcon("C:\\Users\\User\\Downloads\\singleBed.jpg");
		return icon;
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource()==confirmBtn) {
            ...
            adminPage.addBooking(firstName + " " + lastName, email, checkIn, checkOut, roomNumber,"Sleeping One");
